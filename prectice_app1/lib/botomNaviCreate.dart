...
class botomNavicreate extends StatefulWidget {
  const botomNavicreate({super.key});

  @override
  State<botomNavicreate> createState() => _botomNavicreateState();
}

class _botomNavicreateState extends State<botomNavicreate> {
  int currentIndex = 0;
  @override
